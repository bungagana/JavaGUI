...
private showBus showBusInstance;
    ...
    private void initComponents() {
        ...
        labelHeader.setText("Pemesanan Tiket Bus");
    ...
    showBusInstance.updateData(showBusInstance, model);
   ...
   try {
    ...
    String keretaQuery = "INSERT INTO bus (NIK, nama, kotaAsal, tujuan, tanggalBerangkat, harga) VALUES (?, ?, ?, ?, ?, ?)";

    // Query SQL untuk menyimpan data ke tabel penumpang
    String penumpangQuery = "INSERT INTO penumpang_bus (NIK, nama, kotaAsal, tujuan, tanggalBerangkat, Alamat, noHp) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    try (Connection conn = DriverManager.getConnection(url, user, passwordDb);
        ...
        for (int i = 0; i < rowCount; i++) {
            ...
            if (rowsInsertedPesawat > 0) {
                System.out.println("Data berhasil disimpan ke tabel Bus.");
            } else {
                System.out.println("Gagal menyimpan data ke tabel Bus.");
            }
