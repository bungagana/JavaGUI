 ...
 * @author LENOVO
 */
public class showPesawat extends javax.swing.JFrame {
private NonEditableTableModel tabelshowpesawat;
public void tambahDataTabelTiket(String nama, String NIK, String kotaAsal, String tujuan, String tanggalBerangkat, int harga) {
    DefaultTableModel model = (DefaultTableModel) tableshowpesawat.getModel();
   ...
   model.setValueAt(totalHarga, 0, 5);  // Mengisi kolom harga dengan totalHarga}
    ...
    public void updateData(showPesawat showPesawatInstance, DefaultTableModel model) {
    showPesawatInstance.tableshowpesawat.setModel(model);
...
public void tambahDataTabelPenumpang(String nama, String NIK, String kotaAsal, String tujuan, String tanggalBerangkat, String alamat, String noHp) {
  ...
  public void updateDataPenumpang() {
        ...
        String penumpangQuery = "SELECT nama, NIK, kotaAsal, tujuan, tanggalBerangkat, Alamat, noHp FROM penumpang";
...
public class NonEditableTableModel extends DefaultTableModel {
    ...
    public showPesawat() {
        ...
        tabelshowpesawat = new NonEditableTableModel(
            new Object[][] {},
            new String[] {"Nama", "NIK", "Kota Asal", "Tujuan", "Tanggal Berangkat", "Harga"}
        );

        // Atur model tabel showpesawat
        tableshowpesawat.setModel(tabelshowpesawat);
    ...
    private void initComponents() {
        ...
        tableshowpesawat = new javax.swing.JTable();
        ...
        labelHeader.setText("DATA PENUMPANG PESAWAT");
        ...
        tableshowpesawat.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane2.setViewportView(tableshowpesawat);
        ...
        labelHeader1.setText("PEMESANAN TIKET PESAWAT");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new showPesawat().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tableshowpesawat;
