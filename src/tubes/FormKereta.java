...
public class FormKereta extends javax.swing.JFrame {
private showKereta showKeretaInstance;
    ...
    public FormKereta() {
        initComponents();
        showKeretaInstance = new showKereta();
    }
    ...
    private void initComponents() {
        ...
        labelHeader.setText("Pemesanan Tiket Kereta");
    ...
    showKeretaInstance.updateData(showKeretaInstance, model);
    }//GEN-LAST:event_btEditActionPerformed

    private void btAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAddActionPerformed
    String hargaText = inputHarga.getText();
    String nikText = inputNIK.getText();
    int harga;
   try {
        if (nikText.isEmpty()) {
    ...
    showKereta menu = new showKereta();
    ...
    String keretaQuery = "INSERT INTO kereta (NIK, nama, kotaAsal, tujuan, tanggalBerangkat, harga) VALUES (?, ?, ?, ?, ?, ?)";

    // Query SQL untuk menyimpan data ke tabel penumpang
    String penumpangQuery = "INSERT INTO penumpang_kereta (NIK, nama, kotaAsal, tujuan, tanggalBerangkat, Alamat, noHp) VALUES (?, ?, ?, ?, ?, ?, ?)";

    try (Connection conn = DriverManager.getConnection(url, user, passwordDb);
         PreparedStatement keretatStmt = conn.prepareStatement(keretaQuery);
        ...
        for (int i = 0; i < rowCount; i++) {
            ...
            keretatStmt.setString(1, NIK);
            keretatStmt.setString(2, nama);
            keretatStmt.setString(3, kotaAsal);
            keretatStmt.setString(4, tujuan);
            keretatStmt.setString(5, convertDateFormat(tanggalBerangkat));
            keretatStmt.setInt(6, harga);

            // Eksekusi query untuk menyimpan data ke tabel pesawat
            int rowsInsertedPesawat = keretatStmt.executeUpdate();
            if (rowsInsertedPesawat > 0) {
                System.out.println("Data berhasil disimpan ke tabel kereta.");
            } else {
                System.out.println("Gagal menyimpan data ke tabel kereta.");
            }
            ...
            //Memanggil buat tampil ke tabel tiket - penumpanng
...
private String convertDateFormat(String inputDate) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormKereta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormKereta().setVisible(true);
            }
        });
    }
